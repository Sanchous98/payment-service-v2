...
class StorePaymentIntentRequest extends FormRequest
{
    ...
    {
        return new Money((string)$this->str('amount'), new Currency((string)$this->str('currency')));
    }
    ...
    public function threeDS(): ?ThreeDSResult
    {
        ...
        return new ThreeDSResult(
            ...
            (string)$this->str('three_ds.authenticationValue'),
            $this->enum('three_ds.eci', ECICodesEnum::class),
            (string)Uuid::fromString((string)$this->str('three_ds.dsTransactionId')),
            (string)Uuid::fromString((string)$this->str('three_ds.acsTransactionId')),
            '',
    ...
    {
        return Uuid::fromString((string)$this->str('token_id', $this->str('payment_method_id')));
    }
}
