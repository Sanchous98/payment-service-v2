...
class MoonShineUserResource extends ModelResource
{
    ...
    protected string $title { get => __('moonshine::ui.resource.admins_title'); }
    ...
    protected function rules($item): array
    {
        return [
            ...
            'password' => ($item->exists ? 'sometimes|nullable' : 'required') . '|min:6|required_with:password_repeat|same:password_repeat',
        ];
    }
